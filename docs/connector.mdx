...
| User groups      | <Icon icon="square-check" iconType="solid"  color="#65DE23"/>   | <Icon icon="square-check" iconType="solid"  color="#65DE23"/>        |
...
Scroll down to the **Scopes** section of the page. In the **Bot Token Scopes** area, add the following OAuth Scopes:
   ...
   - team:read
   - usergroups:read
   - usergroups:write (include only if you want ConductorOne to provision user group membership)
   - users.profile:read
   - users:read
   - users:read.email
</Step>
...
<Step>
Check that the connector data uploaded correctly. In ConductorOne, click **Apps**. On the **Managed apps** tab, locate and click the name of the application you added the Slack Enterprise Grid connector to. Slack Enterprise Grid data should be found on the **Entitlements** and **Accounts** tabs.
</Step>
</Steps>
**That's it!** Your Slack Enterprise Grid connector is now pulling access data into ConductorOne.
</Tab>
